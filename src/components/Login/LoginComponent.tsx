    ...
    return (
        <motion.div variants={variant1(0.5)} initial="hidden" whileInView="show" viewport={{ once: false, amount: 0.25 }}>
            <div className="flex justify-center items-center h-screen">
                <form className="w-full md:w-3/4 lg:w-2/4 xl:w-1/3 p-8 bg-azul-celeste bg-opacity-50 rounded-lg shadow-lg" onSubmit={handleSubmit(createUser)}>
                    ...
                    <div className="space-y-4">
                        ...
                        <Link to="/login" className="underline text-white">Se não possui conta crie uma</Link>
                    </div>
                </form>
            </div>
        </motion.div>
